...
import 'dart:async';
import 'package:filmanhidayat_17630873/detail.dart';
import 'package:filmanhidayat_17630873/AddData.dart';
...
// ini method yg kita gunakan untuk mengambil data dari server
  Future<List> getData() async {
    final response =
        await http.get("http://192.0.2.2/dbfilman/getKoneksi.php");
